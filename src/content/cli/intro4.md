...
<figure>
{{ @svg @tree/map({ source: samples.ori/cli/greetings.yaml, valueMap: samples.ori/cli/uppercase.js}) }}
</figure>
...
<div class="sideBySide">
  ...
  <figure>
    {{ @svg @tree/map({ source: samples.ori/cli/people.yaml, valueMap: samples.ori/cli/greetings.yaml }) }}
  </figure>
