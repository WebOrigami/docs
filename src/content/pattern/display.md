...
```${'js'}
${ src/js/codeFunctions.js(pattern.ori/flat/json.js).plain }
```
...
${ src/js/codeFunctions.js(pattern.ori/flat/json.js)["@prologue"] }

async function plain(tree) { /* See above */ }

${ src/js/codeFunctions.js(pattern.ori/flat/json.js)["@epilogue"] }
```
