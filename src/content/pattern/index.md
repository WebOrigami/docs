...
This async tree pattern serves as the foundation for the Web Origami project. If you use the [async-tree](/async-tree/) library, or the higher-level parts of Web Origami like the [framework](/framework/) or [command-line interface](/cli/), you will find it useful to understand this foundational pattern.
