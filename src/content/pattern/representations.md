...
```{{'md'}}
{{ source.ori/approaches/markdown/Alice.md }}
```

We want to end up with a corresponding collection of HTML pages, such as `Alice.html`:

```{{'html'}}
{{ @mdHtml source.ori/approaches/markdown/Alice.md }}
```
...
{{ source.ori/approaches/files.js }}
```
...
$ cd src/approaches
$ node files.js
{{ @yaml source.ori/approaches/markdown }}
```
...
{{ source.ori/approaches/object.js }}
```
