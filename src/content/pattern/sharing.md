...
Those things can be accomplished in very little JavaScript code. (Using the even higher-level Web Origami [conceptual framework](/concepts/), you can solve the entire problem without any JavaScript code at all.)
