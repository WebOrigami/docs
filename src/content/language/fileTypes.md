...
```console
$ ori pet.json
${ json(samples.jse/help/pet.json) + "\n" }
```
...
```console
$ ori pet.json/
${ yaml samples.jse/help/pet.json }
```
...
```console
$ ori keys pet.json
${ yaml keys samples.jse/help/pet.json }
```
...
```console
$ ori catBreeds.csv/
${ yaml samples.jse/help/catBreeds.csv }
```
...
$ ori alice.user/
${ yaml jsonParse samples.jse/cli/alice.user }
$ ori alice.user/name
${ (jsonParse samples.jse/cli/alice.user)/name + "\n" }
```
