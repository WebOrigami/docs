...
You can use this system to make new functions available to any part of Web Origami — the ori CLI, the framework's [template system](/concepts/templates.html), `.ori` files, or [expressions in YAML files](yaml.html). All you need to do is make a JavaScript file available somewhere in scope.
