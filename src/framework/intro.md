...
There are a variety of ways to incorporate Origami or its output into an existing web server or a larger project, but for this introduction, you'll use the server built into the companion [ori](/ori) command-line tool.
...
The Origami framework lets you quickly create virtual files and folders by writing formulas. You write those formulas in the _file names_ of real files.
