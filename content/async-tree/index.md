...
This library is an implementation of the [Map Tree pattern](/pattern/). It provides helper classes like [`ObjectMap`](ObjectMap.html) and [`FileMap`](FileMap.html) that can treat a range of data sources as maps.

The library also includes helper functions for common tree operations.
