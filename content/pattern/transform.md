...
<div class="sideBySide split2to3">
  <figure>
    ${ svg(pattern/flat/object.js) }
  </figure>
  <figure>
    ${ svg(pattern/flat/htmlObject.js) }
  </figure>
...
${ pattern/flat/transform.test.js }
```
...
${ Tree.json(pattern/flat/transform.js(Tree.from(pattern/flat/htmlObject.js))) + "\n" }
```
