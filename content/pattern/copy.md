...
<span class="tutorialStep"></span> Use the `build` script to copy the virtual site into a new `build` folder:
...
${ Tree.json(pattern/site/buildFiles.js) + "\n" }
```
