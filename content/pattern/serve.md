...
${ src/js/codeFunctions.js(pattern/deep/serve.js).keysFromUrl }
```
...
${ src/js/codeFunctions.js(pattern/deep/serve.js).traverse }
```
...
${ src/js/codeFunctions.js(pattern/deep/serve.js).requestListener }
```
...
${ src/js/codeFunctions.js(pattern/deep/serve.js)["@prologue"] }

/* …Plus the above code fragments… */

${ src/js/codeFunctions.js(pattern/deep/serve.js)["@epilogue"] }
